var game=document.addEventListener("DOMContentLoaded", ()=> {
...
const render=()=> {
    ...
    if (player.hits<=2 && toggleBtn.innerHTML.value!="click me @2"){ball.x=ball.x+ball.speedX;
    ball.y=ball.y+ball.speedY;
        ...
        toggleBtn.addEventListener("click", ()=>{player.hits=4;
        ball={x:midX, y:0, speedX:1, speedY: 5, hits:4};
